...
var RollbarIntegration = module.exports = integration('Rollbar')
  ...
  .option('source_map_enabled', false)
  .option('code_version', '')
  .option('guess_uncaught_frames', false)
...
RollbarIntegration.prototype.initialize = function() {
  window._rollbarConfig = this.config = {
    ...
    payload: {
      ...
      source_map_enabled: this.options.source_map_enabled,
      code_version: this.options.code_version,
      guess_uncaught_frames: this.options.guess_uncaught_frames
    }
  };
